...
The format and rules for the class change from term to term and are often the result of a class-wide discussion about how to improve the course. The general changes from the Spring 2015 are:
...
\begin{itemize}
    ...
    \item A more FERPA method to return essential questions was added.
