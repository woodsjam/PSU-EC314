...
\ifhybrid \input{HybridWarn} \fi
\ifonline \input{OnlineWarn} \fi
...
Many of the D2L quiz questiions don't have very informative keys. This is partially because may of the questions have several mathematically correct answers or ask for examples, which are by their nature unique for each student. \emph{After the due date feel free to post the full question in piazza.  I and other students will work out an answer key.}
