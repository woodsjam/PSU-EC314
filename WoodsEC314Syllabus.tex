...
\section{Textbooks and Other Resources}
...
online assignments (80\%) and the final exam (20\%).  
...
The final exam will consist of written, not multiple choice questions, covering the same material as the online quizzes and generally problem solving rather than definitional. I will provide you with a sheet of accounting ratios and formulas for some time value of money calculations.  These materials will be posted on D2L in the course materials section.  In the final exam, you will be allowed a calculator and writting implement.  Phones, smart watches, books, computers are not allowed.
...
There are additional requirements for students wishing to be eligible for a grade higher than a C.  Note that these are not required if you are taking the class P/NP and will have no effect on your grade.
 ...
 \subsection{Necessary but not Sufficent Requirements for Passing Grades}\label{sec:essentialSkills}

 The course is focused on four essential skills. You must
 demonstrate proficiency in all four to receive an A in the course and three of the four to recieve a B in the course:
...
There are three kinds of opportunites to pass these essetial skills:
\begin{itemize}
    \item In class
...
Your graded essential questions will be available at the will call window in the Economics office, CH 241, to comply with FERPA.  
...
\begin{enumerate}
    ...
    \item I will evaluate the worked answer once the net rating of the response is at least +5 when I make my daily check and give credit to one of the writters if warranted.

\end{enumerate}

Please note that it is possible for a student to write a poor answer that never never gains enough positive responses for me to evaluate.  It is also possible for a poorly written answer to be edited and improved suffiently for the extra credit to someone other than the original author.
