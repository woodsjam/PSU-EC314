...
You can find the syllabus here. (https://github.com/woodsjam/PSU-EC314/blob/Spring2018/Syllabus/EC314Syllabus.Rmd
)

Almost all the slides will also be on github. (https://github.com/woodsjam/PSU-EC314/tree/Spring2018)

+ Download them before each class if you like but they are not a substitute for coming to class.

# Last Term

Here are Fall term's results https://github.com/woodsjam/PSU-EC314/blob/Spring2018/DayOne/CourseSummary.pdf

+ Note that showing up class helps your grade quite a bit.
+ I also give about 30% As and 30% Bs.
...
+ I never give the same exam.
    + It takes me a 8 hours to create and grade a makeup for you.
    + I only have 6 weekend days off this term and I don't want to give them up.
...
+ Make sure your start time is 8am on the day of the exam.
...
+ The class will use slack https://ec314spring18.slack.com
...
I will assume you know how  to work D2L. https://d2l.pdx.edu/d2l/home/694760
...
+ Getting dated.  
    + If I lose my election, I will start turning it into a book.
    + Book will be free to PSU students.
