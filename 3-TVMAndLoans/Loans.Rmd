...
This equation is not on your note sheet.
...
+ Yes, there are 15-year mortgages, but unless you state that, the assumption is 30-year.
...
+ The terms may be goofy, e.g., weekly payments compounded daily.
...
+ Refinance means taking out a whole new loan with a different interest rate. Unless stated, the same term, e.g., 30-years, as the previous loan.
...
+ Long-timer (30-years)
    + \$30 savings at a cost of \$15
    + Take it and save. \$30 - \$15 = \$15 dollars  
+ Short-timer (5-years)
    + \$5 savings at a cost of \$15
