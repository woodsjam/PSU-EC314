---
title: "Syllabus EC314 Summer 2017"
author: "James Woods"
date: ""
output: pdf_document
---
...
+ Final Exam: August 17th from 4:30 -- 6:50
+ Midterm Exam: July 25th
<!-- + Midterm 1: April 26th -->
<!-- + Midterm 2: May 17th -->
<!-- + Last day to drop or change grade option: May 21st. -->
...
Communication will be handled through slack https://ec314summer17.slack.com/. You should have received an invitation, if not, just go to that URL and use your @pdx.edu email to sign up. There are reasonable help documents to get you started. https://get.slack.help/hc/en-us/articles/218080037-Getting-started-for-new-users
...
+ Drop in office hours are Tuesday 3:00-4:00  through the last week of class. There is no need to make an appointment for these hours -- just come.
...
Office hours for David Hong, the teaching assistant,  will be posted on slack after the first week of class.  We will also post some hours where we will available interactively on slack.
...
## Consequences for Low Scores on Midterms

After each midterm the instructor will announce a cut score for the exam.  If your exam score is equal to or less than the cut score, you will be notified on your returned exam and as a feedback on your grade in D2L. This will trigger additional requirements. Not picking up your exam or reviewing your grades in D2L will not excuse you from these requirements. 

1. You must meet with the instructor or graduate assistant _at least a week before the next exam_ to discuss the exam, course material and how to study for the next exam. Given the volume of appointment slots, scheduling conflicts are not a valid excuse.

1. You will be assigned d2l quizzes covering the material on the exam with the poor score. These quizzes will all start with "REQUIRED" and are different from the voluntary quizzes for grading purposes. These quizzes must be taken and passed with a score of 60\% or better by the due date listed on each quiz. Note that you may take them as many times as you wish.

1. You will be assigned d2l quizzes covering material on the next exam.  You will be required to pass each with a 60\% score or better by the listed due date. These quizzes will all start with "REQUIRED" and are different from the voluntary quizzes for grading purposes. Note that you may take them as many times as you wish.

1. A brief written assignment will be made available to you at the end of each class.  You must pick up and complete the assignment, returning it at the beginning of the next class.  These assignments will be graded on a pass/non-pass basis with fairly low standard.  You must pass 60% of the assignments (rounded down). Nobody other than you will be able to pick up or drop off assignments.

1. Your next exam will include additional _remedial_ questions.  These questions will be graded first on a pass/no pass basis with a fairly low standard. If these questions are not passed, the remainder of the exam will not be graded and you will receive a score of zero.


*Failure to complete these requirements will result in a score of zero on the next exam.*  

The intent of these rules is to force students to refocus on the material so that they will be more successful in the class.

Just because your grade is above the cut score does not mean that you have received a passing grade.

## Voluntary Commitment to "Consequences for Low Scores on Midterms"

Students may volunteer to be treated as if they had a low score, mandatory online quizzes, daily homework and a required meeting from the start of the course. You will not have the special remedial questions on the exam. This can help you commit to coming to class every day and engaging with the material on a regular basis.

You will be able to commit to these requirements through a quiz that will be available the first week of class and after the midterm. 

Please note that failure to satisfy the requirements will result in the same penalties -- a zero on the next exam.
