...
\hline
		...
		Depreciation	&	4000&	3200&\\
        \hline
		Taxable Income	&	(`r -(100 - 50 -4000)`)& (`r -(-500 +700 -300 -3200)`)	&\\
		Tax	&	&	&\\
        \hline
		Net Income	&	&	&\\
\end{tabular}
...
\hline
        ...
        \hline
		Taxable Income	&	(`r -(100 - 50 -4000)`)& (`r -(-500 +700 -300 -3200)`)	&\\
				Tax	&	(`r -(100 - 50 -4000)*.4`)&	(`r -(-500 +700 -300 -3200)*.4`)&\\
        \hline
		Net Income	&	&	&\\
\end{tabular}
\end{table}
...
\hline
		...
		Taxable Income	&	(`r -(100 - 50 -4000)`)& (`r -(-500 +700 -300 -3200)`)	&\\
				Tax	&	(`r -(100 - 50 -4000)*.4`)&	(`r -(-500 +700 -300 -3200)*.4`)&\\
        \hline
		Net Income &	(`r -(100 - 50 -4000)*.6`)&	(`r -(-500 +700 -300 -3200)*.6`)&\\
\end{tabular}
\end{table}
...
\begin{tabular}{l||c|c||p{3cm}}
  ...
  &Year 0  &Year 1  &Note\\        
	Operations&	&	&\\
	\hspace{.25in}Net Income	&	(`r NI0 <- -(100 - 50 -4000)*.6; NI0`)&	(`r NI1 <- -(-500 +700 -300 -6400)*.6; NI1`)&\\
