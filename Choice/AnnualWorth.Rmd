...
+ Two general options:
    + Repeat purchases followed by an equipment lease for the remaing time.
...
The idea was to add Tillapia to the composting and garden cycle. MARR of 10%
...
+ AW Calculations
    ...
    + $AW(Pump 2) = 75 (A|P, i = .1, 5) = `r Acc(agivenp(100, .1, 5))`
