...
The quizzes in D2L are not part of your grade, except for noted below, but you will be hard pressed to pass the class without spending significant time with the material.
...
1. You will be assigned d2l quizzes covering the material on the exam with the poor score.  These quizzes must be taken and passed with a score of 60\% or better by the due date listed on each quiz. Note that you may take them as many times as you wish.  These are separate from the practice quizzes.

1. You will be assigned d2l quizzes covering material on the next exam.  You will be required to pass each with a 60\% score or better by the listed due date. Note that you may take them as many times as you wish. These are separate from the practice quizzes.
