...
\emph{This class will have an in-person final exam at 8am on March 20th.  The final exam is required to pass the class. If you can not attend at that time, please drop the class before January 11th.}
...
\end{itemize}
 ...
 The pre and post quizzes are timed. You have 120 minutes to complete each quiz but the usual time to complete a quiz is approximatly 45 minutes.  Please do not start them and
  then close them without submitting answers; you will recieve a zero on those quizzes.  Only start the quizzes when you have the time to
