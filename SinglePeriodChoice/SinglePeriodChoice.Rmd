...
+ Sometimes you have choices
    + 500 plates
    + 300 tickets
    + \$2500 in food costs (Yes, quantity is sometimes measured like this.)
...
+ Ideally, uncertainty about costs and/or benefits will be small for a known value of volume index.    
...
+ Large uncertainty for length of trip
+ Missed a lot:
...
+ Be sure to sensitivity test this.
    + If your likely volume is not near the volume where the costs are the same -- relax.
    + If the differences between the two technologies are about the same over a likely range -- relax.

Otherwise, You need more certainty about the volume to make a choice.
