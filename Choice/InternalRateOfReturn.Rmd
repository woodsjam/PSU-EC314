...
+ You should remember, you can have more than one root.
...
+ A Has only one sign change and therefore at most one positive real root, IRR.
+ B has two sign changes and therefore *at most* two positive real roots, IRRs.
...
+ If MARR is less than that PW>0 and a good asset.
+ If MARR is greater than that PW<0 and not good.
...
+ If MARR is less than that PW>0 and a bad asset.
+ If MARR is greater than that PW<0 and good asset.
...
The uniqueness of IRRs and the ordering by initial investment, coupled with only have costs in period zero, allows the easy comparison.
