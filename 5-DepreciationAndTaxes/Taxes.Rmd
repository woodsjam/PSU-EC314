...
+ Without support from both major parties, it creates uncertainty about future rates.
    + More likely that there will be changes if either house flips.
    + May actually stifle the positive effects.
    + Makes it hard to round support for fixes.
    
## Some Principles of Taxation

+ Higher taxes on what you don't want and lower taxes, or subsidies, on what you don't want.
