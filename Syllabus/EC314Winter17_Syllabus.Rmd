...
+ Midterm 1: XXX
+ Midterm 2: XXX
+ Last day to drop or change grade option: XXX.
...
Office hours for XXX, the teaching assistant,  will be posted on slack after the first week of class.  We will also post some hours where we will available interactively on slack.
...
After each midterm the instructor will announce a cut score for the exam.  If your exam score is equal to or less than the cut score you will be notified on your returned exam and as a feedback on your grades in D2L. This will trigger additional requirements. Not picking up your exam or reviewing your grades in D2L will not excuse you from these requirements. 

1. You must meet with the instructor or graduate assistant _at least a week before the next exam_ to discuss the exam, course material and how to study for the next exam. Given the volume of appointment slots, scheduling conflicts is not a valid excuse.

1. All practice quizzes covering the material on the exam with the poor score must be taken and passed with a score of 60\% or better _at least a week before the next exam_. Note that you may take them as many times as you wish.

1. All practice quizzes containing material on next exam are mandatory.  You will be required to pass each with a 60\% score or better _at least two days before the next exam_. Note that you may take them as many times as you wish.
...
*Failure to complete complete these requirements will result in a score of zero on the next exam.*  

The intent of these rules is to force students to refocus on the material so that they will be more sucessful in the class.
