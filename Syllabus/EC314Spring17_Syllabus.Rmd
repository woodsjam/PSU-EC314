...
1. You will be assigned quizzes covering material on the next exam.  You will be required to pass each with a 60\% score or better by the listed due date. Note that you may take them as many times as you wish. These are separate from the practice quizzes.
