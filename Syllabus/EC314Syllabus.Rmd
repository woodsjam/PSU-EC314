...
This is a hybrid class.  It is expected that you will have completed all reading, including watching the videos in the course wiki, before the start of class.  If you can't commit to this workload, please consider enrolling in the Winter or Spring sessions, which will be taught as a traditional in-person class.
...
Course grades will be based on class rank with cut points between letter grades determined by gaps in the distribution.  Note that the exams are required.

## In-class quizzes and Class Rules D2L Quiz

These quizzes will be given at the start of class.  They are intended to be a check on if you completed the required reading, including videos in the class wiki, before the start of class.  

They are graded on a pass/no-pass basis and will include very simple questions about the course material.  They will not be returned but a key will be provided. 

In addition to the in class quizzes there is one required D2L quiz covering the syllabus and how to use D2L. There is a separate deadline for this in D2L.
