...
+ If you need to choose about getting more than one.
    ...
    + 1 to 3 French Fries in exclusive choice. {1 French Fry, 2 French Fry, 3 French Fry}
...
+ Gotchas
    ...
    + Econ/Engineer difference.
        ...
        + Economists switch to mixed integer programming.
...
+ Most important when we are looking at service investments. When we must provide specific services for a stated number of years.
...
+ Annual Worth
    ...
    + Exclusive: If assets have the same life, choose largest AW
...
+ Pretty simple, a five year old and a legislator can understand it.
...
+ Putting money in the MARR account always give a PW of zero.
...
You have the choice of two loans with annual payments:

+ 15-year loan at 3%.
+ 30-year loan at 4%

Which do you choose when your savings earns 8%? 